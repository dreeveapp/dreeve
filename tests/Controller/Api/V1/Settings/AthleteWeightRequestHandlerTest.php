...
class AthleteWeightRequestHandlerTest extends ControllerWebTestCase
{
    ...
    public function testItCreatesAWeightForTheSpecifiedDate(): void
    {
        ...
        $this->assertSame(['on' => '2026-09-08', 'weight' => 71.4], $this->settingsRepository->find(SettingsName::WEIGHT_HISTORY)[4]);
    }
    ...
    public function testItUpdatesTheExistingWeightForADate(): void
    {
        ...
        ], $this->settingsRepository->find(SettingsName::WEIGHT_HISTORY));
    }
    ...
    public function testItDeletesAWeightForADate(): void
    {
        ...
        $this->assertNotContains(['on' => '2026-09-08', 'weight' => 71.4], $this->settingsRepository->find(SettingsName::WEIGHT_HISTORY));
    }
