...
class SportTypeNameTest extends TestCase
{
    ...
    public static function provideSportNames(): array
    {
        return [
            ...
            'lap swimming' => ['lap_swimming', SportType::POOL_SWIM],
            'open water swimming' => ['open_water_swimming', SportType::OPEN_WATER_SWIM],
            'open water' => ['open water', SportType::OPEN_WATER_SWIM],
