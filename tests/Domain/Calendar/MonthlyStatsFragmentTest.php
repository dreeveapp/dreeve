...
class MonthlyStatsFragmentTest extends ContainerTestCase
{
    use MatchesSnapshots;
    use ProvideTestData;

    private MonthlyStatsFragment $monthlyStatsPage;
    ...
    protected function setUp(): void
    {
        ...
        $this->monthlyStatsPage = $this->getContainer()->get(MonthlyStatsFragment::class);
    }
}
