...
class MonthFragmentResolverTest extends ContainerTestCase
{
    use MatchesSnapshots;
    use ProvideTestData;

    private MonthFragmentResolver $monthPageResolver;
    ...
    protected function setUp(): void
    {
        ...
        $this->monthPageResolver = $this->getContainer()->get(MonthFragmentResolver::class);
    }
}
