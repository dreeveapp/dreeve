...
class ActivityFragmentResolverTest extends ContainerTestCase
{
    use MatchesSnapshots;
    use ProvideTestData;

    private ActivityFragmentResolver $activityPageResolver;
    ...
    protected function setUp(): void
    {
        ...
        $this->activityPageResolver = $this->getContainer()->get(ActivityFragmentResolver::class);
    }
}
