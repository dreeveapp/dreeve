...
exception: they need to be re-uploaded and re-entered, see [step 7](#7-re-upload-your-images-and-re-enter-your-purchase-prices).
:::
...
[step 6](#6-clean-up-the-old-configuration), after the migration has run.
...
importing from Strava, skip this and move on to [step 4](#4-add-the-new-environment-variables).
...
A full example lives on the [installation](/getting-started/installation/) page.
...
See [Admin password](/getting-started/installation/#admin-password).
:::
...
<Tabs syncKey="import-mode">

<TabItem label="Files mode">
