...
<TabItem label="Invalid permissions">
...
Be sure to [complete the authorization flow](/importing/strava-import/#obtaining-a-strava-refresh-token) and copy/paste the access token to your `.env` file correctly. 
...
<TabItem label="Invalid client_id">
...
<TabItem label="Invalid redirect_uri">
...
<TabItem label="Inactive application">
