...
:::note[Important]
Dreeve uses the <a href="https://docs.neuron-ai.dev">Neuron AI</a> library to interface with AI models.
...
<TabItem label="Locally hosted Ollama">
...
<iframe src="https://www.youtube.com/embed/d1r8ISbRL5o" title="Dreeve" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
