...
:::note[Important]
Wahoo Cloud requires an OAuth 2.0 application. You will need to create a free developer application on Wahoo's portal to obtain a **Client ID** and **Client Secret** before setting up the connector. Read [Register a Wahoo client](/integrations/wahoo-connector/#1-register-a-wahoo-client) first.
:::
